...
function fillReadData(data) {
  ...
  targetDom.eq(4).val(data[0]["no1_0200_ram_speed"]);
  targetDom.eq(5).val(data[0]["no1_0200_ram_pressure"]);
  targetDom.eq(6).val(data[0]["no1_0200_work_temperature"]);
  targetDom.eq(7).val(data[0]["no1_1000_ram_speed"]);
  targetDom.eq(8).val(data[0]["no1_1000_ram_pressure"]);
  targetDom.eq(9).val(data[0]["no1_1000_work_temperature"]);
  targetDom.eq(10).val(data[0]["no1_work_length"]);
  targetDom.eq(11).val(data[0]["no2_0200_ram_speed"]);
  targetDom.eq(12).val(data[0]["no2_0200_ram_pressure"]);
  targetDom.eq(13).val(data[0]["no2_0200_work_temperature"]);
  targetDom.eq(14).val(data[0]["no2_1000_ram_speed"]);
  targetDom.eq(15).val(data[0]["no2_1000_ram_pressure"]);
  targetDom.eq(16).val(data[0]["no2_1000_work_temperature"]);
  targetDom.eq(17).val(data[0]["no2_work_length"]);
...
$(document).on("click", "#test__button", function () {
  ...
  window.open("./DailyReportSub11.html");
});
