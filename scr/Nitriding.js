...
function makeSummaryTable() {
  var fileName = "./php/Nitriding/SelSummary.php";
  var sendData = {
    dummy: "dummy",
  };
  // 今日の日付の代入
...
function fillTableBody(data, tbodyDom) {
  ...
  data.forEach(function (trVal) {
    ...
    if (
      (trVal["after_nitriding_length"] > 2.5 && trVal["die_diamater"] <= 260) ||
      (trVal["after_nitriding_length"] > 3.5 && trVal["die_diamater"] >= 300)
    ) {
      chekFlag = true;
    }
    var newTr = $("<tr>");
...
// -------------------------   summary table tr click   -------------
// +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
$(document).on("click", "#summary__table tr", function () {
